(ns clojure.core.matrix.impl.generic-default
  ...
  (:use clojure.core.matrix.impl.default )
  ...
  (:require [clojure.core.matrix.gen-generic :as gg])
  (:require [clojure.core.matrix :as cm]))



(eval `(do ~@(gg/create-generic-protocol-default-implementations
              ['cm/mul 'cm/add 'cm/sub 'cm/div
               'cm/sub! 'cm/distance 'cm/scale
               'cm/emul 'cm/e* 'cm/negate 'cm/length
               'cm/length-squared 'cm/mmul])))
...
;;   Number
;; P    (generic-add-scaled-product [m a b factor spec]
